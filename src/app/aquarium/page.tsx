...
import { initialAquariums } from "@/data/mock-data-aquarium";
    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-blue-500 to-blue-900">
      ...
      <div className="relative z-10 flex flex-col min-h-screen w-full">
        ...
        <main className="flex-grow mx-auto max-w-7xl px-4 py-8 w-full">
          ...
          <CreateAquariumButton onClickAction={() => setShowPurchaseModal(true)} />
        </main>
      ...
      {showPurchaseModal && (
        <PurchaseModal
          onCloseAction={() => setShowPurchaseModal(false)}
          onPurchaseAction={handleAddAquarium}
