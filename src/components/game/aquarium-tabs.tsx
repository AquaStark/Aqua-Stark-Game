...
function AquariumTab({ name, active, icon, onClick }: AquariumTabProps) {
  return (
    <button
      onClick={onClick}
      className={cn(
        "game-button px-3 md:px-6 py-2 md:py-3 rounded-t-xl font-bold transition-all duration-200 flex items-center text-sm md:text-base",
        active
...
export function AquariumTabs({
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-blue-900/90 to-transparent z-30 p-2 md:p-4">
      <div className="flex justify-between items-end">
        <div className="flex gap-1 md:gap-2 overflow-x-auto flex-1 mr-2">
